...
describe('Open ProntoTools Website', async  () => {
...
/*
    ...
    await page.keyboard.type('barbi_test@outlook.hu')
    await page.keyboard.press('Enter')
    
    await page.waitForSelector('#i0118')
    await page.keyboard.type('T3stJ3lsz0')
    await page.keyboard.press('Enter')
...
*/
  /*  await page.goto('https://outlook.live.com/mail/0/sentitems')
    ...
    //expect('#AQAAAAAAAQABAAAAAyJsDwAAAAA\= > div > div > div > div._1bVZQZoqR8bXQm6sTkfm1W > div._26iAJd-QwDtChfxfbDGH7F > div > span').to.equal("hello")
    page_title = await page.title();
    expect(page_title).to.equal('Ingyenes levelezés és naptár személyes célra a Microsoft Outlookban')
  })
})